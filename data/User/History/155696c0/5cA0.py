...
bot = Bot(command_prefix='$',
        ...
        intents=discord.Intents.default(message_content=True), activity=discord.Activity(type=discord.ActivityType.listening, name='Self laga dunga', status=discord.Status.idle))
